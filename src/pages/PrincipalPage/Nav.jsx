...
export const Nav = ({ pathname }) => {
  ...
  return (
    <div className="shadow-lg bg-[#f7ab5e] border-b-4 border-solid border-chocolate-100 w-full flex flex-row items-start justify-start  box-border max-w-full text-left text-mini-8 text-midnightblue font-inter mq1300:pl-10 mq1300:pr-10 mq1300:box-border ">
      <div className="flex-1 flex flex-row items-center justify-between gap-[45px] max-w-full pt-0 px-10 ">
        <div
        ...
        <div className="w-[519.5px] flex flex-row items-start justify-start gap-[0px_101.9px] max-w-full text-lg mq450:gap-[0px_25px] mq900:w-[354.9px] mq900:gap-[0px_51px]">
