...
export const Perfil = () => {
    ...
    const div = "w-full bg-red-300 h-full  text-white font-monserrat text-4xl border border-solid border-black text-center"
            ...
            <div className={`${div} flex items-center justify-center`}>
                <div className="flex flex-col items-center space-y-4">
                    <div className="relative">
                        <img src={usuario.picture} className="w-[150px] h-[150px] rounded-full" />
