...
export const Cards = () => {
  ...
  let data = alojamiento?.slice(0, 4); 
    ...
    return (
      <div className="mt-[70px] flex-col items-center justify-center gap-10 mx-auto max-w-full text-11xl z-10">
        <div className="flex flex-row items-center justify-between py-0 px-10 box-border w-full">
            ...
            <div>
              <NavLink to="/Principal" className=''>
                <button className="font-custom py-5 pr-7 pl-8 bg-chocolate-100 rounded-[50px] hover:bg-chocolate-200 text-white font-medium cursor-pointer">Más</button>
              </NavLink>
            </div>
          </div>
