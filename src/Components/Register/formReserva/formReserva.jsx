...
export const FormReserva = (id) => {
    ...
    return (
        <form className='flex flex-col items-center justify-center gap-8'>
            ...
            <button className="cursor-pointer border-none py-3 pr-[20.799999999999955px] pl-[21px] bg-[#eb662b] flex-1 rounded-181xl flex flex-row items-start justify-start whitespace-nowrap z-[3] hover:bg-[#d14d12]" onClick={handleClick}
                disabled={open}
