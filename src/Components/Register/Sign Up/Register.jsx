...
const Register = () => {
    return (
        <div className="flex items-center justify-center w-full h-[100vh] text-center rounded bg-salmon font-mono">

                <div className="px-7">
                    <h2 className="text-midnightblue text-2xl mt-7">Crear una cuenta</h2>
                    <div className="py-4 icons">
                        ...
                        <p className="text-white mt-3 ">O usa tu email para registrarte!</p>
                    </div>

                    <form className="mt-4">

                        <label className="flex items-center mb-4 mx-[5%] rounded-[20px] px-5 shadow-md  bg-white">
                        ...
                        <button className="bg-transparent outline-none border-2 border-solid border-gray-500 rounded-2xl m-2 px-5 py-3 text-midnightblue cursor-pointer transition duration-300 ease-in-out hover:bg-midnightblue hover:border-transparent hover:text-white hover:shadow-md"
                        >Registrarme </button>
